##### Example: MetaPipe::meta_analyses()

### This script is an example for the meta_analyses() function in the MetaPipe package.
### The meta_analyses() function performs the final analysis step of the MetaPipe.
...
# the github link the template: https://github.com/JensFuenderich/MetaPipe-OSF-Data/blob/main/Table%20Templates/Merged%20Lab%20Summaries/merged_lab_summeries.csv
folder <- "~/Some_Folder/" # make sure to indicate the correct path to the "Project_Replication_lab_summaries.csv"
Project_Replication_lab_summaries <- read_csv(glue::glue("{folder}merged_lab_summaries.csv"))[,-1]
